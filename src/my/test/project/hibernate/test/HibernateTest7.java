...
public class HibernateTest7 {
	...
	public static void main(String[] args) {
		...
		// Query query = session.createQuery("from Person where id > 5"); //id & personId both works, don't know how
		...
		/*
		 * This above to be discussed with team Why there is no impact of 2nd update I think it's not actually DB again may be as DB has got
		 * the correct result of both queries. So how can we fix FETCH problem here.
		 */
