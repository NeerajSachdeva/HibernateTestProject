...
public class HibernateTest6 {
	...
	public static void main(String[] args) {
		...
		/*
		 * See person2 obj This shows not always set or update method acts. Person person = session.get(Person.class, 5); // READ
		 * person.setName("NICE 5");
		 *
		 * Person person2 = session.get(Person.class, 10); // READ person2 = new Person("1", "2"); System.out.println(person2.getName());
