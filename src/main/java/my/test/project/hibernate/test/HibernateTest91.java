...
public class HibernateTest91 {
	...
	public static void main(String[] args) {
		...
		/*
		 * for (int i = 1; i <= 10; i++) { Person p = new Person("FirstNAME " +
		 * i, "LASTNAME " + i); session.save(p); }
		 */
		...
		// Still no SQL query will be executed for below because of 1st level
		// cache even though person2 is updated as person2 is what
